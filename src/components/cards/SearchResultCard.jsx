...
export default function SearchResultCard({title, text}) {
  ...
  return (
    <article
      ...
      className="h-40 w-full xl:w-lg hover:scale-115 ease-in-out duration-300 flex border-3 rounded-3xl shadow-xl border-gray-100 bg-white overflow-hidden cursor-pointer">
